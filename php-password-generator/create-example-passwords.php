...
// This function will produce example output of the passwords that can be generated
// by this program when used on the web.
//
// Example Usage:
//    php -r "require 'create-example-passwords.php'; createExamplePasswords(1, 250);" > example-passes.txt
function createExamplePasswords($readability, $number) {
